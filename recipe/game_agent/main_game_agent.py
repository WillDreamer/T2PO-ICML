...
@hydra.main(config_path="config", config_name="game_", version_base=None)
def main(config):
    run_ppo(config)
...
class TaskRunner:
    ...
    def add_actor_rollout_worker(self, config):
        ...
        if config.actor_rollout_ref.actor.strategy in {"fsdp", "fsdp2"}:
            from recipe.game_agent.workers.fsdp_workers import ActorRolloutRefWorker, AsyncActorRolloutRefWorker
